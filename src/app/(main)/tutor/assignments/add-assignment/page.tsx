...
export default function AddNewAssignmentPage() {
  ...
  const createAssignment = async () => {
    ...
    try {
      ...
      const createAssignmentResponse = await axiosInstance.post(
        "/assignment",
        payload
      );
      ...
      <section className="flex flex-col gap-5">
        <div className="top-bar">
          {currentUserLoading ? (
            ...
            <Top_Bar subtext={"Add New Assignment"} user={user as User}>
              <p className="flex items-center gap-1">Add Assignment</p>
            </Top_Bar>
          )}
        </div>
        ...
        <div className="p-6 bg-white rounded-xl border border-shade-2 flex flex-col gap-4">
          <h3 className="text-high text-base font-medium">
            Assignment Settings
          </h3>
          ...
          <div className="flex items-center gap-2">
            <Label
              className="text-sm text-low font-medium"
