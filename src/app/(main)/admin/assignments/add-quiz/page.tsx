          ...
          <div className="flex item-center justify-between gap-4 flex-col xl:flex-row">
            ...
            <div className="space-y-2 w-full">
              ...
              <Input
                ...
                onChange={({ target: { value } }) => {
                  if (value === "" || !isNaN(Number(value))) {
                    updateFormData({ ...formData, totalScore: value === "" ? 0 : Number(value) });
                  }
                }}
              />
            </div>
      ...
      <div className="w-full bg-white rounded-xl border border-shade-2 p-6 flex flex-col gap-4">
        ...
        <div className="flex gap-4 flex-col xl:flex-row">
          <div className="py-4 px-6 rounded-xl border border-shade-3 bg-white flex justify-between items-center w-full">
            <Label className="text-sm space-y-2" htmlFor="randomize">
              ...
              <p className="text-low font-normal">The questions can be in any order</p>
            </Label>
            ...
            <div>
              <Switch
                ...
                onCheckedChange={(checked) => updateFormData({ ...formData, randomnize: checked })}
              />
            </div>
          </div>
          ...
          <div className="py-4 px-6 rounded-xl border border-shade-3 bg-white flex justify-between items-center w-full">
            <Label className="text-sm space-y-2" htmlFor="autoGrade">
              ...
              <p className="text-low font-normal"> Allow the system to grade the performance</p>
            </Label>
        ...
        <div className="py-4 px-6 rounded-xl border border-shade-3 bg-white flex justify-between items-center w-full">
          <Label className="text-sm space-y-2" htmlFor="lateSubmission">
            ...
            <p className="text-low font-normal">Allow late submissions from students</p>
          </Label>
          ...
          <div>
            <Switch
              ...
              onCheckedChange={(checked) => updateFormData({ ...formData, allowLate: checked })}
            />
          </div>
        </div>
      </div>
